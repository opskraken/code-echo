...
description: Suggest a new feature for the code-echo MVP
title: '[Feature] code-echo - Brief title'
  ...
  - type: markdown
    attributes:
      value: |
        ...
        ### 1. Problem/Need
        What user pain point does this solve? [e.g., "Code analysis for AI is manual and slow"]
        
        ### 2. Proposed Solution
        High-level: What should the feature do? [e.g., "CLI to bundle code for AI tools"]
        User Story: As a [user type], I want [feature] so that [benefit].
        
        ### 3. Detailed Specs
        - **Inputs/Outputs**: [e.g., "Input: CLI command; Output: Scaffolded folder."]
        - **Edge Cases**: [e.g., "Handle multiple languages."]
        - **Tech Stack**: [e.g., "Golang"]
        ...
        - Impact: [e.g., "High: Core to enable AI-friendly code packaging."]
